...
* 아이디어 
	...
	- 그림으로 보면 다음과 같다.
		...
		* (b) 는 N 번째 날을 포함한 M 일 대관한 경우 중 대관료 평균 최소값을 가진다. 
			* 이 경우의 수는 언제나 한가지 밖에 없다.
		* (c) 는 N - 1 번째 날을 포함한 연속된 M 일 이상 대관시 대관료 평균 최소값에 N 번째 날을 대관한 경우로, 명백히 N - 1 날을 포함한 연속된 M 일 이상 대관시 대관료 평균 최소값을 가진다. 
